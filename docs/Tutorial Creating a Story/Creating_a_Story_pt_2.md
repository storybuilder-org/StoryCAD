...
Brooks offers the following example: a story idea might be to write a story about ballet dancers. A concept might be ‘What if a ballet dancer loses her leg at the knee but perseveres against great prejudice to become a professional dancer?’

For the “Danger Calls” concept, let’s use this:
 
![](../media/Tutorial/Tutorial-2-Concept.png)
...
But questions can also be used to refine and test concepts and many other story elements. StoryCAD contains a tool, Key Questions, for just  this purpose. 
...
![](../media/Tutorial/Tutorial-2-Key-Questions.png)
...
![](../media/Tutorial/Tutorial-2-Add-Character.png)
...
![](../media/Tutorial/Tutorial-2-Detective-Role.png)
...
![](../media/Tutorial/Tutorial-2-Add-New-Role.png)
...
![](../media/Tutorial/Tutorial-2-Third-Character.png)
