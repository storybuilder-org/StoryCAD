...
**Note:** Plotting tools such as Master Plots, Dramatic Situations, and Stock Scenes can only insert new story elements into the Story Explorer View. If you need to add elements using these tools, make sure you’re working in Story Explorer View first.
