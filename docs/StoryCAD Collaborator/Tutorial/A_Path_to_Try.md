...
Collaborator starts with seven of these workflows starred, so they sit at the top of the workflow list before you touch anything: **Premise**, **Story Problem**, **GMC**, **Problem Structure**, **Character Story Function**, **Scene Summary**, and **Scene Conflict**. That is the spine below, minus the optional steps.
...
4. **Goal / Motivation / Conflict (GMC)**  
   Opposing goals and forces on that problem.  
   Craft: [Defining Problems](../../Writing%20with%20StoryCAD/Defining_Problems.html) (GMC)
...
6. **Problem Structure**  
   Beat sheet / shape for the story problem.  
   Craft: [Plotting with StoryCAD](../../Writing%20with%20StoryCAD/Plotting_with_StoryCAD.html)

7. **One character path**  
...
![The workflow pane with the seven starred workflows at the top, in running order](../../media/Collaborator-Workflow-Pane.png)
