...
public class OverviewModel : StoryElement
{
    ...
    // Overview data
    [JsonIgnore] private string _dateCreated;
    ...
    [JsonIgnore] private string _author;
    ...
    [JsonIgnore] private string _dateModified;
    ...
    [JsonIgnore] private string _concept;
    ...
    [JsonIgnore] private Guid _storyProblem; // The Guid of a Problem StoryElement
    ...
    [JsonIgnore] private string _storyType;
    ...
    [JsonIgnore] private string _storyGenre;
    ...
    [JsonIgnore] private string _viewpoint;
    ...
    [JsonIgnore] private string _voice;
    ...
    [JsonIgnore] private string _literaryDevice;
    ...
    [JsonIgnore] private string _tense;
    ...
    [JsonIgnore] private string _style;
    ...
    [JsonIgnore] private string _structureNotes;
    ...
    [JsonIgnore] private string _tone;
    ...
    public OverviewModel(string name, StoryModel model, StoryNodeItem Node) : base(name, StoryItemType.StoryOverview,
        model, Node)
    {
