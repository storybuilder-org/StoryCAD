...
public class StoryModel : ObservableObject
{
    ...
    /// </summary>
    [JsonInclude] internal List<PersistableNode> FlattenedExplorerView;
    ...
    ///     This is only updated on saves.
    /// </summary>
    [JsonInclude] internal List<PersistableNode> FlattenedNarratorView;
    ...
    ///     This is only updated on saves.
    /// </summary>
    [JsonInclude] internal List<PersistableNode> FlattenedTrashView;
    ...
    [JsonIgnore] public ObservableCollection<StoryNodeItem> ExplorerView;

    [JsonIgnore] public ObservableCollection<StoryNodeItem> NarratorView;
