...
public class ToolValidationService
{
        ...
        bool checkOutlineIsOpen = true)
    {
        try
        {
            ...
            {
                Default.Send(new StatusChangedMessage(new(
            ...
            if (checkOutlineIsOpen)
            {
                if (model == null)
                {
                    Default.Send(new StatusChangedMessage(new("Open or create an outline first", LogLevel.Warn)));
                    return false;
                }
            ...
            if (nodeRequired)
            {
                ...
                if (nodeToUse == null)
                {
                    Default.Send(new StatusChangedMessage(new("You need to select a node first", LogLevel.Warn)));
                    return false;
                }
            }
