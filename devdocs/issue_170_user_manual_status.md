...
- [x] Landing page and `What_Collaborator_Is.md`: check the "paid plug-in, dual store, free trial" framing against beta wording. What Collaborator Is no longer states the business terms (item 2). Landing page still says "additional paid feature" and "free trial"; fix in the item 6 pass on `index.md`.
