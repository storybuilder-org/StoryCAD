# StoryBuilder Foundation AI Usage Policy
...
- **How the AI works.** When you use Collaborator, specific story elements from your outline are sent to a commercial AI service to generate suggestions. The results are returned to your machine. We do not store the data that is sent or received, and we do not use it to train anything. You do not need to set up or pay for a separate AI account; Collaborator handles this through StoryCAD. (If you are a developer building with the StoryCAD programming interface, consult the StoryCAD API documentation for technical requirements.)
...
*This policy draws on the Jasper.ai Responsible AI Usage Policy template and reflects positions published by SFWA, the Authors Guild, PEN America, the Writers Guild of America, and the major publishing houses. See the accompanying [AI Policy Citations](issue_1312_ai_policy_citations.md) for sources.*
