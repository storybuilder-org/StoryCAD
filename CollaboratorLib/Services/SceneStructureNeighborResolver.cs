...
public sealed class SceneStructureNeighborResolver
{
    ...
    /// <summary>
    /// Collaborator #208: owner state for SceneBuilder. It was kept separate from Scene
    /// Summary's OwnerState so that workflow was unchanged; #211 deleted Scene Summary.
    /// </summary>
    ...
    public IReadOnlyList<ProblemModel> FindStructureOwners(
        ...
        string scanLabel = "Scene Builder")
    {
