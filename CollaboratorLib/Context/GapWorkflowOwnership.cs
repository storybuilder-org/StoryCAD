...
public static class GapWorkflowOwnership
{
    ...
    public static IReadOnlyList<string> WorkflowsFor(StoryItemType elementType, string propertyName)
    {
        return (elementType, propertyName) switch
        {
            ...
            (StoryItemType.Problem, "ProtGoal") => new[] { "ProblemBuilder", "GMC" },
            (StoryItemType.Problem, "ProtMotive") => new[] { "ProblemBuilder", "GMC" },
            (StoryItemType.Problem, "ProtConflict") => new[] { "ProblemBuilder", "GMC" },
            (StoryItemType.Problem, "AntagGoal") => new[] { "ProblemBuilder", "GMC" },
            (StoryItemType.Problem, "AntagMotive") => new[] { "ProblemBuilder", "GMC" },
            (StoryItemType.Problem, "AntagConflict") => new[] { "ProblemBuilder", "GMC" },
            (StoryItemType.Problem, "Outcome") => new[] { "ProblemBuilder", "GMC" },
