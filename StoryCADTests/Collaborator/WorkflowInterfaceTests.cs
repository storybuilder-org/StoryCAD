...
public class WorkflowInterfaceTests
{
    ...
    {
        private readonly Dictionary<Guid, StoryElement> _elements = new();

        public StoryModel CurrentModel { get; set; } = new();

        public async Task<OperationResult<List<Guid>>> CreateEmptyOutline(string name, string author,
