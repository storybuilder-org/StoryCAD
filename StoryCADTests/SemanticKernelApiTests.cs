...
// Assumes StoryViewType is available in your project (with at least ExplorerView and NarratorView)
using StoryCAD; 
...
namespace StoryCADTests
{
    ...
    {
        private SemanticKernelApi _api;
        ...
        public void TestInitialize()
        {
            ...
            _api = new SemanticKernelApi();

            // Set up a dedicated TestOutputs folder for file-based tests.
            testOutputPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "TestOutputs", "SemanticKernelApiTests");
        ...
        [TestMethod]
        public async Task CreateEmptyOutline_InvalidTemplate_ReturnsFailure()
        {
            // Arrange
            ...
            Assert.IsTrue(result.ErrorMessage.Contains("is not a valid template index"), "Error message should indicate the template index is invalid.");
        }

        [TestMethod]
        public async Task CreateEmptyOutline_ValidTemplate_ReturnsElementGuids()
        {
            // Arrange
            string name = "Test Outline";
            string author = "Test Author";
        ...
        public async Task WriteOutline_WithoutModel_ReturnsFailure()
        {
            ...
            string filePath = Path.Combine(testOutputPath, "NoModel.stbx");
        ...
        public async Task WriteOutline_WithModel_WritesFileSuccessfully()
        {
            ...
            string filePath = Path.Combine(testOutputPath, "Outline.stbx");
        ...
        [TestMethod]
        public async Task AddElement_InvalidParent_ReturnsFailure()
        {
            // Arrange
        ...
        [TestMethod]
        public async Task AddElement_ValidParent_AddsNewElement()
        {
            // Arrange
            string outlineName = "Test Outline";
            string author = "Test Author";
            ...
            // Act
            var addResult = _api.AddElement(StoryItemType.Section, parentGuid.ToString());
            ...
            Assert.AreEqual(StoryItemType.Section, newElement.ElementType, "The new element should be of type Section.");
        }

        [TestMethod]
        public async Task UpdateElementProperty_UpdatesPropertySuccessfully()
        {
            // Arrange
            string originalName = "Original Outline";
        ...
        [TestMethod]
        public async Task OpenOutline_InvalidPath_ReturnsFailure()
        {
            // Arrange
        ...
        public async Task OpenOutline_ValidFile_OpensModelSuccessfully()
        {
            ...
            var createResult = await _api.CreateEmptyOutline(outlineName, author, "0");
            Assert.IsTrue(createResult.IsSuccess, "Model creation should succeed.");
            string filePath = Path.Combine(testOutputPath, "OpenedOutline.stbx");
            var writeResult = await _api.WriteOutline(filePath);
        ...
        [TestMethod]
        public async Task DeleteElement_DeletesElementSuccessfully()
        {
            // Arrange
            string outlineName = "Test Outline";
            string author = "Test Author";
        ...
        [TestMethod]
        public async Task AddCastMember_AddsCastMemberSuccessfully()
        {
            // Arrange
            string outlineName = "Test Outline";
            string author = "Test Author";
        ...
        [TestMethod]
        public async Task AddRelationship_AddsRelationshipSuccessfully()
        {
            // Arrange
            string outlineName = "Test Outline";
            string author = "Test Author";
            ...
            Assert.IsTrue(charResult1.IsSuccess && charResult2.IsSuccess, "Both character elements should be added successfully.");
            ...
            bool relationshipResult = _api.AddRelationship(charElement1.Uuid, charElement2.Uuid, "Friendship", false);
            ...
            Assert.ThrowsException<ArgumentNullException>(() => _api.AddRelationship(Guid.Empty, charElement2.Uuid, "Invalid", false));
        }
    }
}
