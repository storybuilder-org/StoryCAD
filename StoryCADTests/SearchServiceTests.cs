...
namespace StoryCADTests
{
    ...
    public class SearchServiceTests
    {
        ...
        public void SearchUuid_FindsDirectReference()
        {
            ...
            // Act
            var result = _searchService.SearchUuid(problemNode, protagonist.Uuid, _testModel, false);
        ...
        public void SearchUuid_FindsInCollection()
        {
            ...
            // Act
            var result = _searchService.SearchUuid(sceneNode, protagonist.Uuid, _testModel, false);
        ...
        public void SearchUuid_ReturnsFalseForNonExistentUuid()
        {
            ...
            // Act
            var result = _searchService.SearchUuid(heroNode, randomUuid, _testModel, false);
        ...
        public void SearchUuid_HandlesEmptyUuid()
        {
            ...
            // Act
            var result = _searchService.SearchUuid(heroNode, Guid.Empty, _testModel, false);
        ...
        public void SearchUuid_FindsInRelationships()
        {
            ...
            // Act
            var result = _searchService.SearchUuid(protagonistNode, antagonist.Uuid, _testModel, false);
        ...
        {
            // Act
            var result = _searchService.SearchUuid(null, Guid.NewGuid(), _testModel, false);
        ...
        public void SearchUuid_HandlesNullModel()
        {
            ...
            // Act
            var result = _searchService.SearchUuid(heroNode, Guid.NewGuid(), null, false);
