...
public class OutlineServiceTests
{
    ...
    /// <summary>
    ///     Initializes the test environment for each test by instantiating the OutlineService and ensuring the TestOutputs
    ///     folder is clean.
    /// </summary>
    [TestInitialize]
    ...
    public async Task CreateModel_BasicTemplate0_ShouldCreateMinimalModel()
    {
        ...
        // Act
        var model = await _outlineService.CreateModel(outlineName, author, templateIndex);
        ...
        var narrativeFound = model.NarratorView.Any(n => n.Name == "Narrative View");
    ...
    public async Task WriteModel_ShouldWriteFileSuccessfully()
    {
        ...
        var templateIndex = 0;
        var model = await _outlineService.CreateModel(outlineName, author, templateIndex);
        var filePath = Path.Combine(testOutputPath, "TestOutline.json");

        // Act
        var result = await _outlineService.WriteModel(model, filePath);
    ...
    {
        // Arrange
        var nonExistentPath = Path.Combine(testOutputPath, "NonExistentFile.json");
    ...
    public async Task CreateModel_NewModel_ShouldNotBeMarkedAsChanged()
    {
        ...
        var outlineName = "Test Outline";
        var author = "Test Author";
        var templateIndex = 3; // Same template as TestAPIWrite
    ...
    public void SetCurrentView_InvalidViewType_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<ArgumentException>(() => { _outlineService.SetCurrentView(model, (StoryViewType)999); });
    }
    ...
    public void GetStoryElementByGuid_EmptyGuid_ThrowsException()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<ArgumentException>(() => { _outlineService.GetStoryElementByGuid(model, Guid.Empty); });
    }
    ...
    public void UpdateStoryElement_NullModel_ThrowsException()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<ArgumentNullException>(() => { _outlineService.UpdateStoryElement(null, element); });
    }
    ...
    public async Task UpdateStoryElement_NullElement_ThrowsException()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<ArgumentNullException>(() => { _outlineService.UpdateStoryElement(model, null); });
    }
    ...
    {
        // Act & Assert
        Assert.ThrowsExactly<ArgumentNullException>(() => { _outlineService.GetCharacterList(null); });
    }
    ...
    {
        // Act & Assert
        Assert.ThrowsExactly<ArgumentNullException>(() => { _outlineService.GetSettingsList(null); });
    }
    ...
    {
        // Act & Assert
        Assert.ThrowsExactly<ArgumentNullException>(() => { _outlineService.GetAllStoryElements(null); });
    }
    ...
    public async Task MoveToTrash_WithNullElement_ThrowsException()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<ArgumentNullException>(() => { _outlineService.MoveToTrash(null, model); });
    }
    ...
    public async Task MoveToTrash_WithRootNode_ThrowsException()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<InvalidOperationException>(() => { _outlineService.MoveToTrash(overview, model); });
    }
    ...
    public async Task MoveToTrash_WithTrashCan_ThrowsException()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<InvalidOperationException>(() => { _outlineService.MoveToTrash(trashCan, model); });
    }
    ...
    public async Task RestoreFromTrash_WithNullNode_ThrowsException()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<ArgumentNullException>(() => { _outlineService.RestoreFromTrash(null, model); });
    }
    ...
    public async Task RemoveUuidReferences_WithValidUuid_ReturnsAffectedCount()
    {
        ...
        // Act
        var affectedCount = _outlineService.RemoveUuidReferences(model, character.Uuid);
    ...
    public async Task RemoveUuidReferences_WithEmptyUuid_ReturnsZero()
    {
        ...
        // Act
        var affectedCount = _outlineService.RemoveUuidReferences(model, Guid.Empty);
    ...
    public async Task RemoveUuidReferences_WithNoReferences_ReturnsZero()
    {
        ...
        // Act
        var affectedCount = _outlineService.RemoveUuidReferences(model, randomUuid);
    ...
    public async Task AddRelationship_BetweenCharacters_AddsSuccessfully()
    {
        ...
        // Act
        var result = _outlineService.AddRelationship(model, character1.Uuid, character2.Uuid, "Friends", true);
    ...
    public async Task AddRelationship_WithoutMirror_AddsOnlyToSource()
    {
        ...
        // Act
        var result = _outlineService.AddRelationship(model, character1.Uuid, character2.Uuid, "Admires");
    ...
    public async Task AddRelationship_DuplicateRelationship_ShouldNotAddDuplicate()
    {
        ...
        var result = _outlineService.AddRelationship(model, character1.Uuid, character2.Uuid, "Friends");
    ...
    public async Task AddCastMember_ToScene_AddsSuccessfully()
    {
        ...
        // Act
        var result = _outlineService.AddCastMember(model, scene, character.Uuid);
    ...
    public async Task AddCastMember_MultipleCharacters_AddsAll()
    {
        ...
        // Act
        var result1 = _outlineService.AddCastMember(model, scene, character1.Uuid);
        var result2 = _outlineService.AddCastMember(model, scene, character2.Uuid);
        var result3 = _outlineService.AddCastMember(model, scene, character3.Uuid);
    ...
    public async Task ConvertProblemToScene_BasicConversion_Success()
    {
        ...
        Assert.IsFalse(model.StoryElements.Any(e => e.ElementType == StoryItemType.Problem && e.Uuid == originalUuid),
    ...
    public async Task ConvertProblemToScene_WithChildren_MovesChildren()
    {
        ...
        Assert.IsTrue(scene.Node.Children.Any(c => c.Name == "Child Character 1"),
            "Should have child with correct name");
        Assert.IsTrue(scene.Node.Children.Any(c => c.Name == "Child Character 2"),
            "Should have child with correct name");
    ...
    public async Task ConvertSceneToProblem_BasicConversion_Success()
    {
        ...
        Assert.IsFalse(model.StoryElements.Any(e => e.ElementType == StoryItemType.Scene && e.Uuid == originalUuid),
    ...
    public void SaveAndLoadBeatsheet_ShouldPersistBeats()
    {
        ...
        var file = Path.Combine(_testBeatOutputPath, "beats.json");
