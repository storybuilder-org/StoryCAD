...
public class NarrativeToolVMTests
{
    ...
    public void Constructor_HasCorrectDISignature()
    {
        ...
        // Assert
        Assert.IsNotNull(diConstructor, "NarrativeToolVM should have a constructor with (ShellViewModel, AppState, Windowing, ToolValidationService, ILogService) parameters");
    }
